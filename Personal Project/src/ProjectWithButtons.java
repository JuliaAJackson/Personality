...
public class ProjectWithButtons extends JFrame
	{
	...
	private static void greetUser()
		{
			...
			JOptionPane.showMessageDialog(frame, "Hi, " + name + "!");
				...
				private static void complimentUser()
					{
						...
						JOptionPane.showMessageDialog(frame, complimentArray[randomCompliment]);
					}
				private static void giveInfo()
					{
						JOptionPane.showMessageDialog(frame, "Let's find which of the four temperaments you are (options are sanguine, choleric, phlegmatic, or melancholic)");
				...
				private static void giveMoreInfo()
					{
						Object[] options = {"yes", "no"};
						className = JOptionPane.showOptionDialog(frame, "Would you like more information about a personality type?",
								"Personality",
						...
						switch(className)
						{
							case 0:
								{
									JOptionPane.showMessageDialog(frame, "Knowledge is always good!");
									final String[] personality = { "Choleric", "Phlegmatic", "Melancholic", "Sanguine" };
									final JFrame frame = new JFrame();
								    String type = (String) JOptionPane.showInputDialog(frame, 
								            "What personality would you like to learn more about?",
								            "personality",
								            JOptionPane.QUESTION_MESSAGE, 
								            null, 
								            personality, 
									...
									switch(type)
										{
											case "Choleric":
												{
													JOptionPane.showMessageDialog(frame, "A choleric is independent, decisive, and goal oriented");
													break;
												}
											case "Phlegmatic":
												{
													JOptionPane.showMessageDialog(frame, "A phlegmatic is relaxed, peaceful, and quiet");
													break;
												}
											case "Melancholic":
												{
													JOptionPane.showMessageDialog(frame, "A melancholic is analytical, detail oriented, and a deep thinker and feeler");
													break;
												}
											case "Sanguine":
													{
														JOptionPane.showMessageDialog(frame, "A sanguine is enthusiastic, active, and social.");
														break;
													}
							...
							case 1:
								{
								JOptionPane.showMessageDialog(frame, "I see you have already been enlightened! Good Bye!");
								break;
								}
						}
					}
